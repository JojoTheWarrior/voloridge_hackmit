...
from warsignal.fetch import crossref, finance, gdelt_live, materials_project, noaa_isd, open_meteo, open_meteo_aq, openalex, openaq, pudl
...
def run(quick=False):
    ...
    for module in (gdelt_live, noaa_isd, open_meteo, open_meteo_aq, crossref, openaq, openalex, materials_project, pudl):
        module.fetch(**common)
